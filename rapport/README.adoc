...
include::annexes/module classification automatique et traitement du langage.adoc[Avancement module Classification automatique et Traitement du langage]

include::annexes/Module_Recherche_WEB.adoc[Avancement module Recheche Web]

include::annexes/moduleBDD.adoc[Avancement module Base de données]

include::annexes/moduleSocial.adoc[Avancement module Social]

include::annexes/moduleTI.adoc[Avancement module Tests & Intégration]
